 ...
 * ============================================================ */
/* ============================================================
 * v0.31.0 B3：deriveConversation / formatTimeLabel 迁往纯模块
 * `store/derive-conversation.ts`（等价性测试需在 node:test 密闭导入旧路径，
 * meta.ts 依赖 i18n 无法入测）。此处保留同名转出口，消费者零改动。
 * ============================================================ */
export { deriveConversation } from './derive-conversation'
